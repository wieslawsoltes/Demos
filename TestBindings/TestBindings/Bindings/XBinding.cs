...
namespace Test2d
{
    ...
    /// </summary>
    public class XBinding : ObservableObject
    {
        private XBindingMode _mode;
        ...
        /// <summary>
        /// Initializes a new instance of the XBinding class.
        /// </summary>
        public XBinding()
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the XBinding class and initializes binding.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of the XBinding class and initializes binding.
        /// </summary>
        /// <param name="source">The Source object for the binding.</param>
        /// <param name="sourcePropertyName">The Source property for the binding.</param>
        /// <param name="target">The Target object for the binding.</param>
        ...
        /// <param name="mode">The binding mode.</param>
        /// <returns></returns>
        public static XBinding Create(
            object source,
            string sourcePropertyName,
            object target,
            string targetPropertyName,
            XBindingMode mode = XBindingMode.Default)
        {
            return new XBinding(
                source,
                sourcePropertyName,
        ...
        private void ObserveSourceChanges(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                if (_mode == XBindingMode.OneWay 
                    || _mode == XBindingMode.TwoWay)
                {
                    UpdateTarget();
                }
            }
        ...
        private void ObserveTargetChanges(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                if (_mode == XBindingMode.TwoWay 
                    || _mode == XBindingMode.OneWayToSource)
                {
                    UpdateSource();
                }
            }
        ...
        {
            if (_mode == XBindingMode.OneTime 
                || _mode == XBindingMode.OneWay 
                || _mode == XBindingMode.TwoWay)
            {
                UpdateTarget();
            }
            else if (_mode == XBindingMode.OneWayToSource)
            {
                UpdateSource();
            }
        }
        ...
        /// <summary>
        /// Indicates whether the XBinding properties are valid.
        /// </summary>
        /// <returns></returns>
